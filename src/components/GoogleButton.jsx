export default function GoogleButton({ label = "Continuar com Google", onClick }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="w-full py-3 rounded-xl bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-medium text-sm transition-colors inline-flex items-center justify-center gap-2"
    >
